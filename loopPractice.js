...
// //questions - can you do it without creating a local variable
...
//     const vowels = ['a', 'e', 'i', 'o', 'u']; // am i able to just do 'aeiou'??
//     let vowelCount = 0;
...
//     return result;
// }
// console.log(stringFilter(['alice,', 'ed', 'greg', 'gary']));
...
// }
// console.log(sumAverage([22, 8, 6, 2]));
...
//     for (let i = /* `string.length - 1` is used to get the index of the last character in the string.
...
//     for (let i = 0; i < string.length; i++) {
//         reversedString.push(string[i].split('').reverse().join(''));
//     }
//     return reversedString;
// }
